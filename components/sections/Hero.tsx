        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 xl:gap-8 items-center mb-14">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 rounded-full border border-blue-200 w-fit">
              ...
              <span className="text-xs text-blue-700 font-semibold">Tech Solutions</span>
            </div>

            {/* Heading */}
            <div>
              <h2 className="text-xl lg:text-2xl font-black text-slate-900 leading-snug">
                Enterprise-Grade
                <br />
            ...
            <a
              href="#tech-solutions"
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold border border-[#1A56DB]/40 text-[#1A56DB] rounded-lg hover:bg-blue-50 transition-colors w-fit mt-1"
            >
          ...
          >
            ...
            <div className="text-center">
              <div className="flex items-center gap-2 justify-center mb-1">
                ...
                <span className="text-xs text-slate-400 tracking-wider uppercase font-medium">AI-Powered Platform</span>
                <Sparkles size={13} className="text-[#1A56DB]" />
              </div>
            ...
            <div className="flex gap-3 flex-wrap justify-center">
              {[
                ...
                <div key={p.label} className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-xs font-semibold ${p.color}`}>
                  <p.icon size={12} />
                  {p.val} {p.label}
                </div>
              ))}
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-violet-50 rounded-full border border-violet-200 w-fit">
              ...
              <span className="text-xs text-violet-700 font-semibold">Learning Ecosystem</span>
            </div>
            ...
            <a
              href="#courses"
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-[#1A56DB] hover:bg-[#1448C0] rounded-lg transition-colors w-fit mt-1"
            >
        ...
        >
          ...
          <div className="mt-7 flex flex-col sm:flex-row gap-3 justify-center">
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              className="inline-flex items-center justify-center gap-2 px-7 py-3 text-sm font-bold text-white bg-[#1A56DB] hover:bg-[#1448C0] rounded-xl hover:shadow-lg hover:shadow-blue-400/30 transition-all"
            >
              <Rocket size={15} />
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.97 }}
              className="inline-flex items-center justify-center gap-2 px-7 py-3 text-sm font-bold text-slate-700 bg-white border border-slate-200 rounded-xl hover:border-blue-300 hover:text-[#1A56DB] transition-all shadow-sm"
            >
              <Users size={15} />
